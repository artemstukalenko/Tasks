...
public class View {
    ...
    public static final String YOU_WON = "You won! Good job! The sought number was ";
    ...
    public static final String ALREADY_INSERTED = "This value have already been inserted!";
